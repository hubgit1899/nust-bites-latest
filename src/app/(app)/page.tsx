    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center py-12 text-center">
        <div className="max-w-4xl mx-auto bg-base-200/60 backdrop-blur-lg p-8 lg:p-14 rounded-2xl border border-primary/50 shadow-md">
          ...
          <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto text-base-content/80">
            Order from your favorite campus restaurants with fast delivery and
            exclusive deals for NUST students.
          </p>
      ...
      <div className="relative z-10 py-10">
        <h3 className="text-2xl font-bold mb-8 text-center">
          <span className="inline-block pb-2 border-b-2 border-primary">
      ...
      <div className="relative z-10 py-12 bg-base-200 rounded-2xl shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base-content/70">
                Explore our selection of restaurants
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base-content/70">
                Choose your favorite meals and checkout securely
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-base-content/70">
                Our riders deliver your order right to your location
              </p>
            </div>
          </div>
        </div>
